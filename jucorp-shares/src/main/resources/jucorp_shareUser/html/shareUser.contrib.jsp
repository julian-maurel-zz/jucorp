...
<form action="<c:url value='/cms/render/live/fr${currentNode.path}/*'/>" method="post">
    <input type="hidden" name="jcrNodeType" value="jucorp:share"/>
  <input type="hidden" name="jcrRedirectTo" value="<c:url value='http://julian-corporation.com/home'/>"/>
